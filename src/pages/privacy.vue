...
<template>
  <div class="page">
    ...
    <div class="header">
      <div class="container">
        <p class="title">Privacy Policy for doctodoc</p>
      </div>
    </div>
      ...
      <div class="container">
        <div id="en" class="tab-content translations-content-item en visible">
          ...
          <ul>
            ...
            <li>
              <p><strong>Application</strong> refers to Doctodoc, the software program provided by the Company.</p>
            </li>
            <li>
              <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                or &quot;Our&quot; in this Agreement) refers to doctodoc.</p>
            </li>
            <li>
            ...
            <li>
              <p><strong>Website</strong> refers to doctodoc, accessible from <a href="https://doctodoc.fr"
                                                                                 rel="external nofollow noopener"
                                                                                 target="_blank">https://doctodoc.fr</a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>
              <p>By email: <a class="__cf_email__" data-cfemail="6c0f031e09021805024200090f04090209421c1e032c0b010d0500420f0301"
                              href="/cdn-cgi/l/email-protection">[email&#160;protected]</a>
              </p>
            </li>
            <li>
              <p>By visiting this page on our website: <a href="https://doctodoc.fr/privacy"
                                                          rel="external nofollow noopener" target="_blank">https://doctodoc.fr/privacy</a>
              </p>
            </li>
          </ul>
        </div>
...
h6 {
  font-size: cacl(16px); /* Erreur ici corrigée ci-dessous */
}
